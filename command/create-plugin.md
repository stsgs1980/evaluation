...
- [OK] Follows plugin-dev's proven patterns
- [OK] Uses correct naming conventions
- [OK] Has strong trigger conditions (skills/agents)
- [OK] Includes working examples
- [OK] Properly documented
- [OK] Validated with utilities
- [OK] Tested in Claude Code
